## The pair of following functions will compute the inverse of a matrix and cache
## the result so that it can be retrieved to avoid potientally time-consuming  
## computation.
